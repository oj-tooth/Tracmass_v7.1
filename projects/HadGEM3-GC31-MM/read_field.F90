  ...
  ! ==========================================================================
   ...
   IF (ints == 0) THEN
     ...
     IF (loopYears) THEN
       ...
       fieldFile = TRIM(physDataDir)//TRIM(physPrefixForm)//TRIM(hs_name )//TRIM('_')//TRIM(dateprefix)//TRIM(fileSuffix)
   ...
   fieldFile = TRIM(physDataDir)//TRIM(physPrefixForm)//TRIM(ueul_name)//TRIM('_')//TRIM(dateprefix)//TRIM(fileSuffix)
   ...
   fieldFile = TRIM(physDataDir)//TRIM(physPrefixForm)//TRIM(veul_name)//TRIM('_')//TRIM(dateprefix)//TRIM(fileSuffix)
   ...
   IF (l_tracers) THEN
     ...
     DO itrac = 1, numtracers
        ...
        IF (tracers(itrac)%action == 'read') THEN
          ...
          fieldFile = TRIM(physDataDir)//TRIM(physPrefixForm)//TRIM(tracers(itrac)%varname)//TRIM('_')// &
          TRIM(dateprefix)//TRIM(fileSuffix)
          ...
          ELSE IF (tracers(itrac)%dimension == '2D') THEN
                ...
                IF (tracers(itrac)%varname == 'mask') THEN
                    fieldFile = TRIM(physDataDir)//TRIM(killzoneFile)
                    tmp3d(1:imt,1:jmt,1) = get2DfieldNC(fieldFile, tracers(itrac)%varname,[imindom,jmindom,1,1] &
                            ,[imt,jmt,1,1],'st')
                ELSE
